# @odczynflnpm/quas-deserunt-optio

> forked from [@odczynflnpm/quas-deserunt-optioode](https://www.npmjs.com/package/@odczynflnpm/quas-deserunt-optioode) v11.1.0. as the original repository seems [no longer maintained](https://github.com/mysticatea/@odczynflnpm/quas-deserunt-optioode/issues/300).

[![npm version](https://img.shields.io/npm/v/@odczynflnpm/quas-deserunt-optio.svg)](https://www.npmjs.com/package/@odczynflnpm/quas-deserunt-optio)
[![Downloads](https://img.shields.io/npm/dm/@odczynflnpm/quas-deserunt-optio.svg)](https://www.npmjs.com/package/@odczynflnpm/quas-deserunt-optio)
[![Build Status](https://github.com/odczynflnpm/quas-deserunt-optio/workflows/CI/badge.svg)](https://github.com/odczynflnpm/quas-deserunt-optio/actions)
...
```sh
npm install --save-dev eslint @odczynflnpm/quas-deserunt-optio
```
...
```js
const nodePlugin = require("@odczynflnpm/quas-deserunt-optio")
...
💼 [Configurations](https://github.com/odczynflnpm/quas-deserunt-optio#-configs) enabled in.\
☑️ Set in the `flat/recommended` [configuration](https://github.com/odczynflnpm/quas-deserunt-optio#-configs).\
🟢 Set in the `flat/recommended-module` [configuration](https://github.com/odczynflnpm/quas-deserunt-optio#-configs).\
✅ Set in the `flat/recommended-script` [configuration](https://github.com/odczynflnpm/quas-deserunt-optio#-configs).\
☑️ Set in the `recommended` [configuration](https://github.com/odczynflnpm/quas-deserunt-optio#-configs).\
🟢 Set in the `recommended-module` [configuration](https://github.com/odczynflnpm/quas-deserunt-optio#-configs).\
✅ Set in the `recommended-script` [configuration](https://github.com/odczynflnpm/quas-deserunt-optio#-configs).\
...
`@odczynflnpm/quas-deserunt-optio` follows [semantic versioning](http://semver.org/) and [ESLint's Semantic Versioning Policy](https://github.com/eslint/eslint#semantic-versioning-policy).
...
- [GitHub Releases](https://github.com/odczynflnpm/quas-deserunt-optio/releases)
